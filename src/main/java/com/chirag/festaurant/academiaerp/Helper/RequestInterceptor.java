...
public class RequestInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if (request.getRequestURI().startsWith("/api/salary/disburse") && !role.equals("Admin") && !role.equals("Accounts Manager")) {
            response.sendError(HttpServletResponse.SC_FORBIDDEN, "Access Denied to employees");
            return false;
        }
